...
export function MobileDock() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-brand-navy border-t border-brand-navy md:hidden flex justify-around items-center pt-3 pb-[max(env(safe-area-inset-bottom),0.75rem)] shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
      <Link href="tel:+61451178375" className="flex flex-col items-center gap-1 text-white hover:text-brand-teal transition-colors flex-1">
      ...
      <Link href="https://wa.me/61451178375" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 text-white hover:text-[#25D366] transition-colors flex-1">
