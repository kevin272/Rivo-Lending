...
export default function FaqsPage() {
  ...
  return (
    <div className="bg-white min-h-screen overflow-x-hidden relative">
      ...
      <div className="py-12 bg-slate-50 border-t border-slate-100 max-w-[90rem] 2xl:max-w-[120rem] 3xl:max-w-[140rem] mx-auto">
